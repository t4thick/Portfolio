...
export default function Footer() {
  ...
  return (
    <footer className="bg-[var(--background)] text-[var(--foreground-dim)] border-t border-[var(--border)] py-8 px-6 md:px-12">
      <div className="md:ml-64 max-w-4xl mx-auto text-center">
        ...
        <p className="text-sm font-mono">
          Designed & Built by Richard Effah Yeboah
        </p>
